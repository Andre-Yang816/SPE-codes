        ...
        for file in files:
            ...
            for r in range(10):
                ...
                if modelname == "LTR-linear":
                    de = LTR(X=trainX, y=training_data_y, cost=cost, costflag='loc', logorlinear=logorlinear, metircs=target)
                ...
                falsealarmrate20module, IFMA, IFLA, PMI, PLI, PofB, PofBPLI = PerformanceMeasure(
...
if __name__ == '__main__':
    ...
    models = ["LR", "RR", "LTR-linear"]
    for flag in flags:
        for model in models:
            logorlinear = 'linear'
            target = 'pofb20'

            model_path = '../Models_count/CrossProject/' + flag + '/' + model +'/'
            save_path = '../output_Count_final/CrossProject/' + flag + '/'

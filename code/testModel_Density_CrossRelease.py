...
if __name__ == '__main__':
    ...
    model_path1 = '../Models/number_crossRelease/LTR-linear/'
    model_path2 = '../Models/number_crossRelease/LTR-log/'
    model_path3 = '../Models/number_crossRelease/DEJIT/'
    model_path4 = '../Models/wn_crossRelease/LTR-linear/'
    model_path5 = '../Models/wn_crossRelease/LTR-log/'
    model_path6 = '../Models/wn_crossRelease/DEJIT/'
    ...
    for flag in flags:
        for model in models:
            ...
            save_path = '../output_Density_final/crossRelease/' + flag + '/'
